package com.conferencehub.keynote.config;
...
public class SecurityConfig {
   ...
   * Roles in Keycloak are already prefixed with ROLE_ (e.g. ROLE_ADMIN),
   * so Spring Security's hasRole('ADMIN') will match correctly.
   */
